...
public class Movie   {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.title, movie.title) &&
        ...
        Objects.equals(this.length, movie.length) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, director, genre, rating, length, releaseDate, reviewScore, currentlyPlaying, upcomingRelease);
  }
